...
// versions:
//   sqlc v1.29.0
// source: 0002_pre_go_acc_user_info_9999.sql
...
const addUserAutoId = `-- name: AddUserAutoId :execresult
...
type AddUserAutoIdParams struct {
	UserAccount          string
...
func (q *Queries) AddUserAutoId(ctx context.Context, arg AddUserAutoIdParams) (sql.Result, error) {
	return q.db.ExecContext(ctx, addUserAutoId,
		arg.UserAccount,
		arg.UserNickname,
		arg.UserAvatar,
		arg.UserState,
